        ...
        <div class="layout_left_menu">
            <ul id="menu">
                <li class="childUlLi">
                    ...
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/user/comment/listByBlogId" target="menuFrame">
                 ...
                 <li class="childUlLi">
                    ...
                    <ul>
                        <li>
                            <a href="${pageContext.request.contextPath}/user/user/updatePre" target="menuFrame">
                        ...
                        <li><a href="${pageContext.request.contextPath}/user/user/import.jsp" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>更新照片</a>
                        </li>
                    </ul>
                </li>
